...
public sealed class IndoorBikeData(IFitnessMachineData data) : IIndoorBikeData
{
    ...
    public IFitnessMachineValue? InstantaneousCadence => data.GetValue(FtmsUuids.InstantaneousCadence);
    public IFitnessMachineValue? AverageCadence => data.GetValue(FtmsUuids.AverageCadence);
